...
function reimburseUserDetails(req, res) {
    if (!req.body.Item || !req.body.Item.ReimbusmentId) {
        res.status(400).json({ error: 'ReimbusmentId is missing in the request body' });
    } else {
        ...
        if (emp_access == 'L3' || emp_access == 'L2' || emp_access == 'L1' || emp_access == 'A1' || emp_access == 'F1') {
            var id = req.body.Item.ReimbusmentId;
...
function approve(req, res) {
    ...
    var emp_id = req.body.row.emp_id;
    // var emp_access = req.body.row.user_type;
    var emp_name = req.body.row.emp_name;
    var remb_id = "";
    var lodge_date = "";
    var rowDataReject = "";
    var rowDataApprvd = "";
    ...
    var billupld_flg = "Y";
    if (test == "Approve") {
        var remb_id = req.body.row.remb_id;
        console.log("Inside approve", remb_id);
        var lodge_date = req.body.row.lodge_date;
        console.log("Inside approve", lodge_date);
        var manager_remarks = req.body.row.manremarks;
