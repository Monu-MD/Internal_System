...
function requestLeave(req, res) {
    ...
    var sessiontyp = req.body.sessionType;
...
//     pool.query("SELECT * from leave_master where leave_type = $1 and del_flg = $2 and emp_id = $3 and year = $4", [leave_id, 'N', emp_id, year], function (err, availedList) {
//         if (err) {
//             console.error('Error with table query', err);
//         }
//         else {
...
//         pool.query("SELECT * from leave_config where leave_type = $1 and del_flg = $2 and year=$3", [leave_id, 'N', year], function (err, noOfLeavesList) {
//             if (err) {
//                 console.error('Error with table query', err);
//             }
//             else {
...
//             pool.query("SELECT * from leave_master where leave_type = $1 and del_flg = $2 and year=$3 and emp_id=$4", [leave_id, 'N', year, emp_id], function (err, noOfLeavesList) {
//                 if (err) {
//                     console.error('Error with table query', err);
//                 }
//                 else {
...
//         pool.query("SELECT * from emp_master_tbl where del_flg = $1 order by emp_id asc", ['N'], function (err, resultset) {
//             if (err) {
//                 console.error('Error with table query', err);
//             }
//             else {
...
//             pool.query("SELECT quaterly_leave from leave_master where leave_type = $1 and del_flg = $2 and year=$3 and emp_id=$4", [leave_id, 'N', year, emp_id], function (err, noOfLeavesList) {
//                 if (err) {
//                     console.error('Error with table query', err);
//                 }
//                 else {
...
//     pool.query("SELECT * from holidays where sel_date between($1) and ($2) and del_flg = $3", [fromDate, toDate, 'N'], function (err, noOfDaysList) {
//         if (err) {
//             console.error('Error with table query', err);
//         }
//         else {
...
//     pool.query("SELECT gender,martial_status from emp_info_tbl where emp_id = $1 and del_flg = $2", [emp_id, 'N'], function (err, result) {
...
//                             pool.query("SELECT * from leave_config where year=$1 and del_flg = 'N' and leave_type!='ML'", [current_year], function (err, leaveConfigList) {
//                                 if (err) {
//                                     console.error('Error with table query', err);
//                                 }
//                                 else {
...
//                                     pool.query("SELECT day_type,sel_date,description,year FROM holidays where del_flg ='N' and day_type in ('W','O') order by current_date", function (err, openList) {
//                                         if (err) {
//                                             console.error('Error with table query', err);
//                                         }
//                                         else {
...
//                             pool.query("SELECT * from leave_config where year=$1 and del_flg = 'N' and leave_type!='PL'", [current_year], function (err, leaveConfigList) {
//                                 if (err) {
//                                     console.error('Error with table query', err);
//                                 }
//                                 else {
...
//                             pool.query("SELECT * from leave_config where year=$1 and del_flg = 'N' and leave_type!='ML' and leave_type!='PL'", [current_year], function (err, leaveConfigList) {
//                                 if (err) {
//                                     console.error('Error with table query', err);
//                                 }
//                                 else {
...
//     pool.query("SELECT * from emp_master_tbl where del_flg='N' order by emp_id asc", function (err, done) {
//         if (err) {
//             console.error('Error with table query', err);
//         }
//         else {
...
//         pool.query("SELECT * from emp_info_tbl where emp_id =$1 and del_flg=$2", [eid, 'N'], function (err, done) {
//             if (err) {
//                 console.error('Error with table query', err);
//             }
//             else {
...
//                     holidayData = holidayList.rows;
//                 }
//                 pool.query("select emp_id, emp_name from emp_master_tbl where emp_id in( SELECT reporting_mgr FROM emp_master_tbl where emp_id =$1)", [eid], function (err, emp_data) {
//                     if (err) {
//                         console.error('Error with table query', err);
//                     }
//                     else {
...
//                                     pool.query("update leave_master set availed_leaves = $1,lchg_user_id = $2,lchg_time =$3,quaterly_leave =$6 where year = $4 and emp_id = $5 and leave_type = $7 ", [total_leaves, eid, rcretime, year, emp_id, borr_leaves, leave_type], function (err, done) {
//                                         if (err) throw err;
//                                     });
//                                 }
...
//                                     pool.query("update leave_master set availed_leaves = $1 , lchg_user_id = $2, lchg_time =$3 where year = $4 and emp_id = $5 and leave_type = $6 ", [total_leaves, eid, rcretime, year, emp_id, leave_type], function (err, done) {
//                                         if (err) throw err;
//                                     });
//                                 }
...
//             pool.query("SELECT * from emp_master_tbl where emp_id = $1 and entity_cre_flg = 'Y' and del_flg = 'N'", [emp_id], function (err, result) {
//                 if (err) {
//                     console.error('Error with table query', err);
//                 }
//                 else {
...
//     pool.query("SELECT comm_code_desc cocd ,emp_name emp,* from leaves l, emp_master_tbl emp, common_code_tbl cocd  where l.del_flg= 'N' and l.app_flg != '' and l.emp_id = emp.emp_id and rej_flg = 'N' and cocd.del_flg ='N' and emp.del_flg ='N' and cocd.comm_code_id = l.leave_type and cocd.code_id ='LTYP'", function (err, leavesList) {
//         if (err) {
//             console.error('Error with table query', err);
//         }
//         else {
...
//     pool.query("SELECT comm_code_desc cocd, * from leaves l ,common_code_tbl cocd  where l.del_flg= 'N' and l.leave_id = $1 and cocd.comm_code_id = l.leave_type and cocd.code_id ='LTYP' and  cocd.del_flg= 'N'", [leave_id], function (err, leavesList) {
//         if (err) {
//             console.error('Error with table query', err);
//         }
//         else {
...
//     pool.query("SELECT comm_code_desc cocd ,emp_name emp,* from leaves l, emp_master_tbl emp, common_code_tbl cocd  where l.del_flg= 'N' and l.emp_id = emp.emp_id and cocd.del_flg ='N' and emp.del_flg ='N' and cocd.comm_code_id = l.leave_type and cocd.code_id ='LTYP'", function (err, leavesList) {
//         if (err) {
//             console.error('Error with table query', err);
//         }
//         else {
...
//         pool.query("SELECT * from emp_master_tbl where reporting_mgr=$1 and del_flg = $2 order by emp_id asc", [eid, 'N'], function (err, resultset) {
//             if (err) {
//                 console.error('Error with table query', err);
//             }
//             else {
